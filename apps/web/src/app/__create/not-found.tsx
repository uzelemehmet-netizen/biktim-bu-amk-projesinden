...
export default function CreateDefaultNotFoundPage() {
  ...
  // Statik route listesi (SPA modunda loader kullanılamaz)
  const existingRoutes = [
    { path: 'Homepage', url: '/' },
    { path: '/hakkinda', url: '/hakkinda' },
    { path: '/seyahat', url: '/seyahat' },
    { path: '/evlilik', url: '/evlilik' },
    { path: '/youtube', url: '/youtube' },
    { path: '/iletisim', url: '/iletisim' },
